    ...
    if request.method  == 'POST':
            ...
            try:
                ...
                if contractor.password != oldpwd:
                    ...
                    return redirect('contractorchange')
                ...
                return redirect('sign')   
    return render(request,'contractorchange.html',{'contractorid':contractorid})
...
def applyproject(request,id):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            messages.error(request,"Invalid estimated_budget") 
            return redirect('contractorviewprojects')   
...
def addprogress(request,id):
    ...
    if request.method == 'POST':
        ...
        if progress_percent > 100:
            ...
            messages.error(request,"Progress cannot be less than 0% or  less than the prevsion progress ")
            return redirect('addprogress',id=id)
        if progress_percent == 100:
