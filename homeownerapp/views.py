    ...
    if request.method  == 'POST':
            ...
            try:
                ...
                if homeowner.password != oldpwd:
                    ...
                    return redirect('homeownerchange')
                ...
                return redirect('sign')   
    return render(request,'homeownerchange.html',{'homeownerid':homeownerid})
...
def approveapp(request,id):
    ...
    project.status =  'under_constructions'
    project.save()
